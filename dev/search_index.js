...
{
    "location": "#The-Juno-IDE-Documentation-1",
    "page": "Home",
...
{
    "location": "#Reporting-Issues-/-Bugs-1",
    "page": "Home",
...
{
    "location": "man/installation/#Installation-Instructions-1",
    "page": "Installation Instructions",
    "title": "Installation Instructions",
    "category": "section",
...
{
    "location": "man/installation/#.-Install-Julia-1",
    "page": "Installation Instructions",
...
{
    "location": "man/installation/#On-Windows-1",
    "page": "Installation Instructions",
    "title": "On Windows",
    "category": "section",
...
{
    "location": "man/installation/#On-OS-X-1",
    "page": "Installation Instructions",
    "title": "On OS X",
    "category": "section",
...
{
    "location": "man/installation/#On-Linux-1",
    "page": "Installation Instructions",
    "title": "On Linux",
    "category": "section",
...
{
    "location": "man/installation/#.-Install-Atom-1",
    "page": "Installation Instructions",
...
{
    "location": "man/installation/#.-Install-Juno-1",
    "page": "Installation Instructions",
...
{
    "location": "man/installation/#Note-1",
    "page": "Installation Instructions",
    "title": "Note",
    "category": "section",
...
{
    "location": "man/installation/#.-Use-Juno-1",
    "page": "Installation Instructions",
    "title": "4. Use Juno",
    "category": "section",
...
{
    "location": "man/installation/#Common-Problems-1",
    "page": "Installation Instructions",
...
{
    "location": "man/installation/#Juno-could-not-be-started.-1",
    "page": "Installation Instructions",
...
{
    "location": "man/basic_usage/#Basic-Usage-1",
    "page": "Basic Usage",
    "title": "Basic Usage",
    "category": "section",
...
{
    "location": "man/basic_usage/#The-Command-Palette-1",
    "page": "Basic Usage",
    "title": "The Command Palette",
    "category": "section",
    "text": "To open the command panel, use Ctrl+Shift+p or go to Packages > Command Palette > Toggle. In the command palette you can search for common commands. For example, type in \"julia\" and you will see the commands which relate to Julia (and the keyboard shortcuts for the commands)."
},

{
    "location": "man/basic_usage/#Opening-the-Console-Window-1",
    "page": "Basic Usage",
...
{
    "location": "man/basic_usage/#Inline-Evaluation-1",
    "page": "Basic Usage",
...
{
    "location": "man/basic_usage/#Cell-Evaluation-1",
    "page": "Basic Usage",
...
{
    "location": "man/basic_usage/#Activating-the-debugger-1",
    "page": "Basic Usage",
    "title": "Activating the debugger",
    "category": "section",
    "text": "Activate the Juno debugger from the console like this:Juno.@enter gcd(10, 20)An editing pane will switch to the source for gcd and you will be able to step through it using a debug controller or key bindings (see below). Your console which switch to a debug> prompt, from which you can evaluate expressions that reference variables internal to gcd.See Debugging for a step-by-step guide."
},

{
    "location": "man/basic_usage/#Common-Keyboard-Shortcuts-1",
    "page": "Basic Usage",
    "title": "Common Keyboard Shortcuts",
    "category": "section",
    "text": "For MacOS, replace Ctrl by Cmd.Ctrl+Shift+p - Open the command panel\nCtrl+Enter - Evaluate at the cursor\nCtrl+Shift+Enter - Evaluate the current file\nCtrl+j Ctrl+o - Open the console\nCtrl+j Ctrl+c - Clear the console\nCtrl+j Ctrl+s - Start Julia\nCtrl+j Ctrl+k - Kill the Julia process\nCtrl+j Ctrl+r - Open a REPL\nCtrl+j Ctrl+p - Open the Plot Pane\nCtrl+j Ctrl-d - Get the documentation for the symbol under the cursor\nCtrl+j Ctrl-g - Go to the definition of the symbol under the cursorWhen debugging,F10 - advance to next expression\nF11 - step into function call\nShift-F11 - step out of function call"
},

{
    "location": "man/basic_usage/#Adding-Your-Own-Shortcuts-1",
    "page": "Basic Usage",
...
{
    "location": "man/basic_usage/#Using-the-Plot-Pane-1",
    "page": "Basic Usage",
...
{
    "location": "man/basic_usage/#The-Plots.jl-Ecosystem-1",
    "page": "Basic Usage",
...
{
    "location": "man/basic_usage/#Gadfly-1",
    "page": "Basic Usage",
    "title": "Gadfly",
    "category": "section",
...
{
    "location": "man/basic_usage/#Using-the-Workspace-Pane-1",
    "page": "Basic Usage",
...
{
    "location": "man/debugging/#Debugging-1",
    "page": "Debugging",
    "title": "Debugging",
    "category": "section",
    "text": "Open a console and type Juno.@enter split(\"Hello, world\", isspace). You should see something like the following (without the red annotations):(Image: debugging1)(Your arrangement of panes may be different, but if you wish you can adjust these to match.) Some of the key features of this display are annotated in red. We\'re going to walk through some of these item-by-item.The first thing to note is that a window has opened to util.jl, with a little \"bug icon\" next to it. This is a view of the source code that defines the split function you\'ve entered into. Execution is paused at the first line, a call to _split.Now turn your attention to the upper right. There are two key elements there, a control bar and a display of the next statement to be executed. Try hovering over the buttons on the control bar to get a sense for what they do (we\'ll use some of them in a minute).Notice that the \"next expression\" display does not show _split; instead, it\'s <:(String, SubString), which originates from a portion of that first line, in the source written as T <: SubString. (T is a type parameter, the type of str which here is String.) This is an indication that before calling _split, we have to do a bit of preliminary work.In the control bar, find the button for \"Next Expression\" and click it. While the line in the source code display (the pane with util.jl) doesn\'t change its location, you can see an update in the next expression to be executed, now apply_type(SubString, String), meaning it will be executing the SubString{T}.Continue to press \"Next Expression\" until the call to _split is queued up. Then press the button just to the right, \"Step into Function\". Now you\'ll see a change in the source window, a jump to a new execution point within _split.Now let\'s turn our attention to a few other elements. The \"Callstack\" pane to the right should show a chain of calls; the first one (the one we entered) is at the bottom, and the current one is at the top. In this particular case you\'ll note a strange entry, something along the lines of #split#328 (the specific number may be different for you). This is revealing some of the internals of how Julia handles functions that have keyword arguments. To keep things from getting too tedious, the debugger stepped over some of the preparatory steps needed to construct the appropriate keyword arguments, but you can see the evidence in the callstack.Below the Callstack pane is a very important pane, \"Breakpoints.\" Breakpoints allow you to skip over many lines without stepping, and then stop at a particular line. You can set breakpoints in the console using the commands implemented by JuliaInterpreter, but perhaps easier is to click in the leftmost column (you\'ll need to run using Revise prior to this). You\'ll see this location gets added to the list (previously empty) of breakpoints on the right hand side.(Image: debugging2)Up in the Debugger control bar, click the double-arrows indicating \"Continue.\" You should see the execution jumps to the position of the breakpoint; the values of variables in the Workspace plane also update to reflect the new state.In the Breakpoint panel, here are some fun things to try:uncheck the box next to this breakpoint location; you should see the red dot to the left of the source line dim. This is an indication that you\'ve disabled this breakpoint; it hasn\'t been forgotten, but you\'ve made it inactive (the fact that it hasn\'t been forgotten can be especially useful in conjunction with conditional breakpoints, discussed next). Click the box again to reactivate it.\nclick the icon that looks like a fork in the road (\"Edit Condition\"). A dialog should open asking you to insert a breakpoint condition. The workspace indicates that j has a value of 7; type in j > 8 and click \"Confirm.\" Note that the icon next to that source line has turned blue, indicating a conditional breakpoint. Given the condition on j you entered and the fact that the input string does not have any spaces at positions higher than 7, this breakpoint would not have been hit.\nTo try out your new conditional breakpoint, first exit debugging by clicking the \"x\" in the Debugger control bar. Your console should return to the normal julia> prompt; now, enter Juno.@run split(\"Hello there, world\", isspace), where @run is like @enter followed by clicking \"Continue\". You\'ll return to the breakpoint, but now j==13 and the first substring, \"Hello,\" has already been entered into strs. This demonstrates that you already completed the first iteration of this while loop before the condition was satisfied.\nExit debugging again and click the \"Clear Breakpoints\" Check the \"Break on Exception\". Then enter an expression that would normally trigger an error: Juno.@enter convert(UInt, -8). (You can\'t convert a negative number to a UInt.) Click \"Continue.\" You should advance to a method, throw_inexacterror. Examine the Callstack pane to see the chain of calls that got you here.This isn\'t an exhaustive overview of debugging in Juno, but hopefully it\'s enough to help you get started exploring on your own."
},
...
{
    "location": "man/faq/#I-am-having-issues,-where-do-I-leave-a-bug-report?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#The-installation-of-some-Atom-packages-fails.-What-can-I-do?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#Juno-doesn\'t-work-properly-after-an-Atom-update.-What-do-I-do?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#Juno-doesn\'t-work-properly-after-some-Atom-packages-were-updated.-What-do-I-do?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#The-REPL-is-unbearably-slow.-How-do-I-fix-it?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#Some-Juno-package-is-using-the-wrong-precompile-cache,-what-do-I-do?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#I-am-having-a-problem-running-Juno-with-an-older-version-of-Julia,-why?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#How-do-I-use-Juno-with-the-Julia-Nightly-version?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#How-do-I-execute-code-on-Juno-startup?-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#Advanced-topics-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#Connecting-to-a-Julia-session-on-a-remote-machine-1",
    "page": "FAQ",
...
{
    "location": "man/faq/#Prerequisites-1",
    "page": "FAQ",
    "title": "Prerequisites",
    "category": "section",
...
{
    "location": "man/faq/#Connecting-to-a-Julia-session-in-a-(local)-Docker-container-1",
    "page": "FAQ",
...
{
    "location": "man/juno_frontend/#Juno.isactive",
    "page": "The Juno.jl Front-End",
    "title": "Juno.isactive",
    "category": "function",
...
{
    "location": "man/juno_frontend/#The-Juno.jl-Front-End-1",
    "page": "The Juno.jl Front-End",
    "title": "The Juno.jl Front-End",
    "category": "section",
...
{
    "location": "man/juno_frontend/#Juno.structure",
    "page": "The Juno.jl Front-End",
...
{
    "location": "man/juno_frontend/#Enhanced-Display-1",
    "page": "The Juno.jl Front-End",
...
{
    "location": "man/juno_frontend/#Juno.profiler",
    "page": "The Juno.jl Front-End",
    "title": "Juno.profiler",
    "category": "function",
...
{
    "location": "man/juno_frontend/#Juno.profiletree",
    "page": "The Juno.jl Front-End",
...
{
    "location": "man/juno_frontend/#Profiler-1",
    "page": "The Juno.jl Front-End",
    "title": "Profiler",
    "category": "section",
...
{
    "location": "man/juno_frontend/#Juno.@progress",
    "page": "The Juno.jl Front-End",
    "title": "Juno.@progress",
    "category": "macro",
...
{
    "location": "man/juno_frontend/#Progress-Meters-1",
    "page": "The Juno.jl Front-End",
...
{
    "location": "man/juno_frontend/#Juno.selector",
    "page": "The Juno.jl Front-End",
    "title": "Juno.selector",
    "category": "function",
...
{
    "location": "man/juno_frontend/#Juno.notify",
    "page": "The Juno.jl Front-End",
    "title": "Juno.notify",
    "category": "function",
...
{
    "location": "man/juno_frontend/#Juno.syntaxcolors",
    "page": "The Juno.jl Front-End",
...
{
    "location": "man/juno_frontend/#Juno.clearconsole",
    "page": "The Juno.jl Front-End",
...
{
    "location": "man/juno_frontend/#Interaction-1",
    "page": "The Juno.jl Front-End",
    "title": "Interaction",
    "category": "section",
...
{
    "location": "man/info_developer/#Information-for-Package-Developers-1",
    "page": "Information for Package Developers",
    "title": "Information for Package Developers",
    "category": "section",
    "text": ""
...
{
    "location": "man/info_developer/#Custom-Inline-Display-1",
    "page": "Information for Package Developers",
...
{
    "location": "man/info_developer/#Displaying-Plots-and-Graphics-1",
    "page": "Information for Package Developers",
...
{
    "location": "devdocs/contributor_guide/#",
...
{
    "location": "devdocs/contributor_guide/#Contributor-Guide-1",
    "page": "Contributor Guide",
    "title": "Contributor Guide",
    "category": "section",
    "text": ""
...
{
    "location": "devdocs/contributor_guide/#Help-and-Bug-Reporting-1",
    "page": "Contributor Guide",
...
{
    "location": "devdocs/contributor_guide/#Contributing-to-the-Packages-1",
    "page": "Contributor Guide",
...
{
    "location": "devdocs/contributor_guide/#Contributing-to-the-Documentation-1",
    "page": "Contributor Guide",
...
{
    "location": "devdocs/dev_install/#Developer-Installation-Instructions-1",
    "page": "Developer Installation Instructions",
    "title": "Developer Installation Instructions",
    "category": "section",
    "text": ""
...
{
    "location": "devdocs/dev_install/#Julia-Packages-1",
    "page": "Developer Installation Instructions",
...
{
    "location": "devdocs/dev_install/#Atom-Packages-1",
    "page": "Developer Installation Instructions",
    "title": "Atom Packages",
    "category": "section",
...
{
    "location": "devdocs/package_info/#Juno-Package-Information-1",
    "page": "Juno Package Information",
    "title": "Juno Package Information",
    "category": "section",
...
{
    "location": "devdocs/package_info/#Atom-Packages-1",
    "page": "Juno Package Information",
    "title": "Atom Packages",
    "category": "section",
...
{
    "location": "devdocs/package_info/#Julia-Packages-1",
    "page": "Juno Package Information",
    "title": "Julia Packages",
    "category": "section",
...
{
    "location": "devdocs/juno_ci/#Juno\'s-CI-1",
    "page": "Juno\'s CI",
    "title": "Juno\'s CI",
    "category": "section",
    "text": ""
...
{
    "location": "devdocs/communication/#",
    "page": "Communication",
    "title": "Communication",
    "category": "page",
    "text": ""
...
{
    "location": "devdocs/communication/#Communication-1",
    "page": "Communication",
    "title": "Communication",
    "category": "section",
...
{
    "location": "devdocs/communication/#Sending-messages-from-Atom-1",
    "page": "Communication",
...
{
    "location": "devdocs/communication/#Sending-messages-from-Julia-1",
    "page": "Communication",
...
{
    "location": "devdocs/communication/#Debugging-and-Learning-1",
    "page": "Communication",
